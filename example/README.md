...
- **opencode-cmd-to-github/** - Runs OpenCode against many org repos via a `cmd-to-github` action and opens a PR in each (checkout → run agent → commit → push → PR). See its own [README](opencode-cmd-to-github/README.md).
